  ...
  <svg version="1.1"
    ...
    <g>
      <g>
        <g>
          ...
          <image style="overflow:visible;opacity:0.28;"
                 width="320"
                 height="211"
      ...
      <g class="st0">
        ...
        <rect x="44.7"
              ...
              width="212.1"
              height="34.4" />
        <text transform="matrix(1 0 0 1 47.2058 329.1734)"
              class="st4">
          <tspan x="0"
                 y="0"
                 class="st23 st24 st25">Lorem ipsum dolor sit amet, consectetur adipiscing </tspan>
          <tspan x="0.6"
                 y="11.7"
                 class="st23 st24 st25">elit, sed do eiusmod tempor incididunt ut labore et </tspan>
          <tspan x="6.2"
                 y="23.3"
                 class="st23 st24 st25">dolore magna aliqua. Ut enim ad minim veniam.</tspan>
        </text>
        <g class="st4">
          <path class="st10"
    ...
    <g>
      ...
      <text opacity="0.6"
            ...
            font-size="25">此路不通 :(
        <tspan x="35"
               y="292">您无权访问该页面!</tspan>
        <tspan x="100"
               y="357"
               fill="#000"
               font-size="65">403</tspan>
        <tspan x="93"
               y="381.2"
               fill="#000"
               font-size="15">Access Forbidden.</tspan>
      </text>
